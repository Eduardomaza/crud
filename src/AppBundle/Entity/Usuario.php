...
class Usuario
{
     ...
     * @var string
     *
     * @ORM\Column(name="ape_paterno", type="string", length=100)
     */
    private $apePaterno;
     ...
     * @var string
     *
     * @ORM\Column(name="ape_materno", type="string", length=100)
     */
    private $apeMaterno;
    ...
    // ...
    /**
    *@ORM\ManyToOne(targetEntity="Direccion", inversedBy="usuario")
